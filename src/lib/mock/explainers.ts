...
export const explainers: Explainer[] = [
  ...
  // ----------------------------------------------- Product and delivery
  {
    ...
    why:
      "It is where tokenised deposits and stablecoins meet technically. Stablecoins such as USDC live on public Ethereum as standard tokens; Besu lets a bank run a private network using those same standards. That shared language is what makes future interoperability between a bank's tokenised deposits and regulated stablecoins plausible. Two precise points to hold: first, being on the same technology does not make a tokenised deposit a stablecoin — the legal claim is still completely different. Second, HSBC's Tokenised Deposit Service network has been reported by trade press as built on Besu, but HSBC's own releases do not name the technology — so say ‘it has been reported’, or ask it as a question, rather than stating it as confirmed. The Hyperledger Besu page covers what to know in depth.",
    category: "Technology",
