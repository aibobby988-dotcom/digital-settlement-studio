import { HelpCircle, ListChecks, Info, Sparkles } from "lucide-react";
  ...
  return (
    <div className="space-y-10">
      <PageHeader
        ...
        description="Defending the case study, questions worth asking, and logistics — the product-knowledge half of interview prep. Personal / behavioral prep stays in a private document, not here."
      />
      ...
      <div className="flex items-start gap-3 rounded-xl border border-blue-100 bg-blue-100/20 px-4 py-3.5">
        ...
        <p className="text-[12.5px] leading-relaxed text-charcoal-900">
          This page is public, like the rest of the case study — it&apos;s product reasoning, not
          personal information. Your STAR stories, &ldquo;why this role&rdquo; answers and anything
          tied to your real career history are kept in a separate private document so they
          aren&apos;t readable by anyone who finds this site before the interview.
        </p>
      </div>
