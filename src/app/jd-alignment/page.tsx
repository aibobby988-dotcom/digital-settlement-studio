  ...
  return (
    <div className="space-y-10">
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <Card><CardHeader title="Recommended screen-share route" /><ol className="space-y-2.5 text-[12.5px] leading-relaxed text-ink-700"><li><strong className="text-charcoal-900">1. Extending TDS:</strong> open by showing you know what is already live, then give the two tracks. This frames everything after it.</li><li><strong className="text-charcoal-900">2. Tokenised Treasury (Track 1):</strong> run the cash-pooling engine — money moving on policy, plus two refusals the client configured themselves.</li><li><strong className="text-charcoal-900">3. Bond DvP (Track 2):</strong> the cash leg settling against a third-party asset. Say explicitly that the Orion case is proven and this is the extension.</li><li><strong className="text-charcoal-900">4. Commercial Model:</strong> retained balances are roughly five times fee revenue. Volunteer the rate sensitivity before you are asked.</li><li><strong className="text-charcoal-900">5. Risk &amp; Controls:</strong> only if the conversation turns to risk. Proof it can operate inside a bank.</li><li><strong className="text-charcoal-900">6. AI in This Product:</strong> close on the mandate demo for ninety seconds. The refusal is the point.</li></ol></Card>
